...
class Translation2d {
 public:
   ...
   */
  constexpr Translation2d(double distance, const Rotation2d& angle)
   ...
   */
  constexpr double Distance(const Translation2d& other) const {
   ...
   */
  constexpr double Norm() const { return std::hypot(m_x, m_y); }
